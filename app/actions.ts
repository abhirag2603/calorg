...
import { onboardingSchemaValidation,aboutSettingsSchema,eventTypeSchema,EventTypeServerSchema} from "./lib/zodSchemas";
...
export async function updateAvailabilityAction(formData: FormData):Promise<any> {
  const session = await requireUser();
